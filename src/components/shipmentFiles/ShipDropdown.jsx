    ...
    <div style={{ position: "absolute", top: "123px", left: "120px", width: "60%", zIndex: "999px" }}>
      ...
      >
        ...
        <div style={{ fontSize: "140px" }}>
          ...
          <li>
            <Link to="/loginhome/createNewShipment">Create a Shipment</Link>
          </li>
          <li
            onClick={() => {
          ...
          >
            <Link to="/loginhome/createFromPast">Create Shipment from the past</Link>
          </li>
          <li>
            <Link to={"/loginhome/createFromFav"} >Create Shipment from Favorite</Link>
          </li>
          <li>
            <Link to="/loginhome/getQuote">Get a Rate and Time Quote</Link>
          </li>
          <li>
            <Link to="/loginhome/schedulePickUp">Schedule a Pickup</Link>
          </li>
          <li>
            <Link to="">Order Supplies</Link>
          </li>
        </div>
        <div>
